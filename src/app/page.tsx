        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10 py-24">
          <div className="max-w-4xl">
            <ScrollReveal direction="up" delay={0.1}>
              <div className="inline-flex items-center space-x-2 border border-slate-700/60 bg-slate-800/30 backdrop-blur-sm px-3 py-1 mb-8 shadow-sm rounded-sm">
          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
            ...
            <div className="w-full lg:w-1/2">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {[
                  { title: "Investment Solutions", desc: "Bespoke capital allocation.", delay: 0.2 },
                  { title: "Fund Management", desc: "Rigorous portfolio oversight.", delay: 0.3 },
                  { title: "Capital Advisory", desc: "Strategic structural guidance.", delay: 0.4 },
                  { title: "Institutional Distribution", desc: "Global partnership networks.", delay: 0.5 }
                ].map((item, i) => (
                  <ScrollReveal key={i} direction="up" delay={item.delay}>
                    <div className="bg-white p-8 border border-slate-100 shadow-lg shadow-slate-200/50 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group cursor-pointer rounded-xl h-full flex flex-col justify-between">
                      <div>
